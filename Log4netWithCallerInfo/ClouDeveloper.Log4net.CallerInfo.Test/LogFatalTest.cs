...
{
    [TestFixture]
    public sealed class LogFatalTest
    {
        ...
        public void EmptyCallerInfo()
        {
            ...
            mock
                .Setup(x => x.Fatal(It.IsAny<object>()))
                .Callback<object>(x =>
                {
                    Assert.That(x, Is
                        .Not.Null
        ...
        public void MessageAndException()
        {
            ...
            mock
                .Setup(x => x.Fatal(It.IsAny<object>(), It.IsAny<Exception>()))
            ...
            CallerInfoLog log = new CallerInfoLog(mock.Object);
            log.Fatal("Hello, World!", new Exception("Surpirse!!"));
            Assert.That(invoked, Is.True);
        }
